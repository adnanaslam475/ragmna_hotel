...
export function Secondary() {
	const Toastslidewarn = () =>
		toast.error(<p className="text-white tx-16 mb-0">Oops! An Error Occurred</p>, {
...
export function LeftNotifier() {
	const Toastslidewarn = () =>
		toast.warn(<p className="text-white tx-16 mb-0">Warning: Something Went Wrong</p>, {
...
export function GradientSuccess() {
	...
	return (
		<div>
			<Button className="me-2" variant="success-gradient" onClick={Toastslidewarn}>
				Success
			</Button>
		</div>
	)
...
export function GradientWarning() {
	...
	return (
		<div>
			<Button className="me-2" variant="warning-gradient" onClick={Toastslidewarn}>
				Warning
			</Button>
		</div>
	)
...
export function GradientDanger() {
	...
	return (
		<div>
			<Button className="me-2" variant="danger-gradient" onClick={Toastslidewarn}>
				Danger
			</Button>
		</div>
	)
