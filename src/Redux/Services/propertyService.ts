...
export const updateProperty = (id, payload) => {
  return apiInstance.put(GET_PROPERTY + `/${id}`, payload, {
    headers: authHeader(),
  });
};
export const getSettingById = (id, typeId) => {
  return apiInstance.get(`${id}/` + RESERVATION + `/${typeId}/type`, {
    headers: authHeader(),
  });
};
export const saveSettingById = (id, payload) => {
  return apiInstance.post(`${id}/` + RESERVATION, payload, {
    headers: authHeader(),
  });
};
...
export const addTaxConfig = (id, payload) => {
  return apiInstance.post(`${id}/` + TAX_CONFIG, payload, {
    headers: authHeader(),
  });
};
export const updateTaxConfig = (id, payload, taxId) => {
  return apiInstance.put(`${id}/` + TAX_CONFIG + `/${taxId}`, payload, {
    headers: authHeader(),
  });
};
export const deleteTaxDataById = (id, taxId) => {
  return apiInstance.delete(`${id}/` + TAX_CONFIG + `/${taxId}`, {
    headers: authHeader(),
  });
};
