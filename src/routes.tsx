...
import { AddRoomType } from './components/Setup/PropertySpace/layout'
...
const CreateSeason = lazy(() => import('./components/Setup/RateSetup/CreateSeason/CreateSeason'))
const EditRate = lazy(() => import('./components/Setup/RateSetup/EditRateSetup/EditRateSetup'))
						...
						{user.accessToken ? (
							<Route path={``} element={<App />}>
								...
								<Route>
									...
									<Route path={`/setup/propertysetup/add-property`} element={<AddProperty />} />
									<Route path={`/setup/propertyspace/add-roomtype`} element={<AddRoomType />} />
									<Route path={`/setup/propertyspace/add-roomtype/:id`} element={<AddRoomType />} />
									<Route path={`/setup/propertysetup/add-property/:id`} element={<AddProperty />} />
