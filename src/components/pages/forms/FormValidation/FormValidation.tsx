						...
						<Card.Body>
							<Form className="was-validated">
								...
								<div className="custom-control custom-checkbox mb-3">
									...
									<Form.Label className="custom-control-label" forhtml="customControlValidation1">
								...
								<div className="custom-control custom-radio">
									...
									<Form.Label className="custom-control-label" forhtml="customControlValidation2">
								...
								<div className="mb-3">
									<InputGroup hasValidation className="flex-nowrap">
										<InputGroup.Text className="py-2" id="validatedInputGroupPrepend">
											Option
										</InputGroup.Text>
