...
class DefaultCalender extends React.Component<any, DemoAppState> {
	...
	addlabel = debounce(() => {
		console.log('aSD')
		document.querySelectorAll('[role="gridcell"] .fc-datagrid-cell-main').forEach((cell, index) => {
								...
								<Col sm={12} style={{ paddingLeft: 0 }}>
									<div style={{ height: '343px', overflowY: 'scroll' }}>
										<FullCalendar
											...
											customButtons={{
												myCustomButton: {
													text: (<i className="fa fa-calendar" style={{ color: 'white' }} />) as unknown as string,
