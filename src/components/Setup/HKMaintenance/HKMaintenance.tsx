...
import { Tab, Row, Col, Nav, Card, Accordion, Form, Collapse, Dropdown, ButtonGroup, Table } from 'react-bootstrap';
            ...
            <Tab.Container id="left-tabs-example" defaultActiveKey="first">
              <div className='tab-name'>
                <Nav variant="pills" className='panel-tabs nav-tabs panel-secondary'>
                  ...
                  <Nav.Item>
                    <Nav.Link eventKey="first"><i className="fe fe-user me-1"></i>HK List</Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="second"><i className="fe fe-calendar me-1"></i>Task Technology</Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="third"><i className="fe fe-settings me-1"></i>Task Type</Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="four"><i className="fe fe-user me-1"></i>Note Types</Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="five"><i className="fe fe-calendar me-1"></i>Maintenance Reason</Nav.Link>
                  </Nav.Item>
                </Nav>
              </div>
